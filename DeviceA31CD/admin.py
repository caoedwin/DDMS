...
from .models import DeviceA31CD, DeviceA31CDHis, DeviceIntfCtgryList, DeviceDevCtgryList, DeviceDevpropertiesList, DeviceDevVendorList, DeviceDevsizeList

# Register your models here.
@admin.register(DeviceA31CD)
class DeviceA31CDAdmin(admin.ModelAdmin):
    fieldsets = (
        (None, {
...
@admin.register(DeviceA31CDHis)
class DeviceA31CDHisAdmin(admin.ModelAdmin):
    fieldsets = (
        (None, {
