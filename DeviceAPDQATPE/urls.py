...
app_name = 'DeviceAPDQATPE'
urlpatterns = [


    path('BorrowedDeviceAPDQATPE/', views.BorrowedDeviceAPDQATPE, name='BorrowedDeviceAPDQATPE'),
    ...
    path('DeviceAPDQATPE_api/', views.DeviceAPDQATPEView.as_view(), name='DeviceAPDQATPE_api'),# 用于认证测试
]