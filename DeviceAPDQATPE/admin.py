...
from .models import DeviceAPDQATPE, DeviceAPDQATPEHis, DeviceIntfCtgryList, DeviceDevCtgryList, DeviceDevpropertiesList, DeviceDevVendorList, DeviceDevsizeList

# Register your models here.
@admin.register(DeviceAPDQATPE)
class DeviceAPDQATPEAdmin(admin.ModelAdmin):
    fieldsets = (
        (None, {
...
@admin.register(DeviceAPDQATPEHis)
class DeviceAPDQATPEHisAdmin(admin.ModelAdmin):
    fieldsets = (
        (None, {
