...
from .models import DeviceA31PCP, DeviceA31PCPHis, DeviceIntfCtgryList, DeviceDevCtgryList, DeviceDevpropertiesList, DeviceDevVendorList, DeviceDevsizeList

# Register your models here.
@admin.register(DeviceA31PCP)
class DeviceA31PCPAdmin(admin.ModelAdmin):
    fieldsets = (
        (None, {
...
@admin.register(DeviceA31PCPHis)
class DeviceA31PCPHisAdmin(admin.ModelAdmin):
    fieldsets = (
        (None, {
