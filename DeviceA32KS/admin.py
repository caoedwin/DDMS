...
from .models import DeviceA32KS, DeviceA32KSHis, DeviceIntfCtgryList, DeviceDevCtgryList, DeviceDevpropertiesList, DeviceDevVendorList, DeviceDevsizeList

# Register your models here.
@admin.register(DeviceA32KS)
class DeviceA32KSAdmin(admin.ModelAdmin):
    fieldsets = (
        (None, {
...
@admin.register(DeviceA32KSHis)
class DeviceA32KSHisAdmin(admin.ModelAdmin):
    fieldsets = (
        (None, {
