...
from .models import DeviceA31TPE, DeviceA31TPEHis, DeviceIntfCtgryList, DeviceDevCtgryList, DeviceDevpropertiesList, DeviceDevVendorList, DeviceDevsizeList

# Register your models here.
@admin.register(DeviceA31TPE)
class DeviceA31TPEAdmin(admin.ModelAdmin):
    fieldsets = (
        (None, {
...
@admin.register(DeviceA31TPEHis)
class DeviceA31TPEHisAdmin(admin.ModelAdmin):
    fieldsets = (
        (None, {
