...
from .models import DeviceA32TPE, DeviceA32TPEHis, DeviceIntfCtgryList, DeviceDevCtgryList, DeviceDevpropertiesList, DeviceDevVendorList, DeviceDevsizeList

# Register your models here.
@admin.register(DeviceA32TPE)
class DeviceA32TPEAdmin(admin.ModelAdmin):
    fieldsets = (
        (None, {
...
@admin.register(DeviceA32TPEHis)
class DeviceA32TPEHisAdmin(admin.ModelAdmin):
    fieldsets = (
        (None, {
