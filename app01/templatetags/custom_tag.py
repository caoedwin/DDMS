            ...
            if item.get('url'): # 说明循环到了菜单最里层的url
                ...
                if item.get('children'):
                    ...
                    if item['title'] == 'Bouncing':
                        ...
                        Class = "ti-list"
                    elif item['title'] == 'D_L_Device-C38-LNV' or item['title'] == 'D_3_Device-A39-OBI'  or item['title'] == 'D_Device' or item['title'] == 'D_A31CD_Device-A31CD' or item['title'] == 'D_A31LKE_Device-A31LKE' or item['title'] == 'D_A31TPE_Device-A31TPE' or item['title'] == 'D_A32TPE_Device-A32TPE' or item['title'] == 'D_APDQATPE_Device-APDQATPE':# or item['title'] == 'D_L_Device-LNV' or item['title'] == 'D_A_Device-ABO':
                        Class = "ti-view-list"
                        ...
                        Class = "ti-notepad"
                    elif item['title'] == 'P_S_個人設備Summary' or item['title'] == 'S_TUM_TUMHistory' or item['title'] == 'D_Summary_DeviceSummary' or item['title'] == 'D_TestDevice_TestDeviceLNV':
                        Class = "ti-bar-chart-alt"
                    elif item['title'] == 'S_A_系统管理':
                        Class = "ti-panel"
                    elif item['title'] == 'W_L_WirelessAP':
                        Class = "ti-layout-media-overlay-alt"
                    elif item['title'] == 'CabM_智能櫃體' or item['title'] == 'Retained_留樣系統':
                        Class = "ti-files"
                    # else:
                    #     Class = "ti-arrow-circle-right"
