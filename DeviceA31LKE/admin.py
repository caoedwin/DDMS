...
from .models import DeviceA31LKE, DeviceA31LKEHis, DeviceIntfCtgryList, DeviceDevCtgryList, DeviceDevpropertiesList, DeviceDevVendorList, DeviceDevsizeList

# Register your models here.
@admin.register(DeviceA31LKE)
class DeviceA31LKEAdmin(admin.ModelAdmin):
    fieldsets = (
        (None, {
...
@admin.register(DeviceA31LKEHis)
class DeviceA31LKEHisAdmin(admin.ModelAdmin):
    fieldsets = (
        (None, {
