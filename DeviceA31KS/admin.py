...
from .models import DeviceA31KS, DeviceA31KSHis, DeviceIntfCtgryList, DeviceDevCtgryList, DeviceDevpropertiesList, DeviceDevVendorList, DeviceDevsizeList

# Register your models here.
@admin.register(DeviceA31KS)
class DeviceA31KSAdmin(admin.ModelAdmin):
    fieldsets = (
        (None, {
...
@admin.register(DeviceA31KSHis)
class DeviceA31KSHisAdmin(admin.ModelAdmin):
    fieldsets = (
        (None, {
